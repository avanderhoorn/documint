...
export function LeafPortal({ anchor, children, className, status = "default" }: LeafPortalProps) {
  ...
  const shellClassName = className ? `documint-leaf-shell ${className}` : "documint-leaf-shell";
