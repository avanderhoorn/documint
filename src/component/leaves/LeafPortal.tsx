...
export function LeafPortal({
  ...
  const shellClassName = className
    ? `documint-editor-leaf-shell ${className}`
    : "documint-editor-leaf-shell";

  return createPortal(
    <div
      className="documint-editor-leaf-anchor"
    ...
    >
      {showBridge ? <div className="documint-editor-leaf-bridge" /> : null}
      <div
