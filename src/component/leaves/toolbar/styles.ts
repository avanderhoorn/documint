...
:where(.documint-editor-leaf-toolbar) {
...
:where(.documint-editor-leaf-toolbar-group) {
  display: inline-flex;
  align-items: center;
  gap: 0.38rem;
}

:where(.documint-editor-leaf-toolbar-divider) {
  width: 1px;
  height: 1.15rem;
  background: var(--documint-leaf-toolbar-divider-color);
}

:where(.documint-editor-leaf-toolbar-button),
:where(.documint-editor-leaf-toolbar-menu-item) {
  appearance: none;
  display: inline-flex;
  align-items: center;
  gap: 0.36rem;
...
:where(.documint-editor-leaf-toolbar-menu-shell .documint-editor-leaf-toolbar-button) {
  gap: 0.18rem;
}

:where(.documint-editor-leaf-toolbar-button:hover) {
  background: var(--documint-leaf-toolbar-button-active-bg);
}

:where(.documint-editor-leaf-toolbar-button:disabled) {
  opacity: 0.42;
  cursor: default;
}

:where(.documint-editor-leaf-toolbar-button:disabled:hover) {
  background: transparent;
}

:where(.documint-editor-leaf-toolbar-button.active) {
  background: var(--documint-leaf-toolbar-button-active-bg);
  color: var(--documint-leaf-text);
}

:where(.documint-editor-leaf-toolbar-menu-shell) {
  position: relative;
}

:where(.documint-editor-leaf-toolbar-menu-chevron) {
  transition: transform 140ms ease;
}

:where(.documint-editor-leaf-toolbar-menu-chevron.is-open) {
  transform: rotate(180deg);
}

:where(.documint-editor-leaf-toolbar-menu-popover) {
  position: absolute;
...
:where(.documint-editor-leaf-toolbar-menu-item:hover) {
  background: var(--documint-leaf-toolbar-menu-hover-bg);
}

:where(.documint-editor-leaf-toolbar-menu-item:disabled) {
  opacity: 0.42;
  cursor: default;
}

:where(.documint-editor-leaf-toolbar-menu-item:disabled:hover) {
  background: transparent;
}

:where(.documint-editor-leaf-toolbar-menu-divider) {
  height: 1px;
