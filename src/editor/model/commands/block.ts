...
// Block structure transaction resolvers: split, backspace, heading depth, and
...
function demoteHeadingToParagraph(context: RootTextBlockContext): EditorTransaction | null {
