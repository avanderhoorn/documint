...
export function moveCaretVertically(state: EditorState, layout: ViewportLayout, direction: -1 | 1) {
...
export function moveCaretByViewport(state: EditorState, layout: ViewportLayout, direction: -1 | 1) {
  const caret = measureSelectionCaret(state, layout);
